...
const events = [
  {
    id: "jharkhand-tech-summit-2026",
    title: "Jharkhand Tech Summit 2026 - Day 1",
  },
  {
    id: "devfest-ranchi-2026",
    title: "DevFest Ranchi 2026",
  },
  {
    id: "calcutta-hacks-2026",
    title: "Calcutta Hacks 2026",
  },
];
...
export default function CreateAlbumPage() {
  ...
  const saveDraft = () => {
    console.log("Album draft:", form);
  };

  const createAlbum = () => {
    console.log("Create album:", form);
  };
      ...
      >
        <div
          className="
            ...
            grid-cols-1
            gap-3
            xl:grid-cols-[minmax(0,1.15fr)_minmax(350px,0.85fr)]
            2xl:grid-cols-2
          "
        >
          {/* =================================================
                      ...
                      className={`
                        ...
                        ${
                          form.visibility === "public"
                            ...
                            : "border-white/[0.06] bg-[#202126] hover:bg-[#24252a]"
                        }
                      `}
                    >
