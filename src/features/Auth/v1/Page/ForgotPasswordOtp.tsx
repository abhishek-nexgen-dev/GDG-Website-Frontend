...
const ForgotPasswordOtp = () => {
  return (
    <div className="Forgot-Password-Page relative flex min-h-screen w-full items-center justify-center bg-bg-primary p-4 text-white sm:p-6 lg:p-8">
      ...
      <div className="Form-Container mt-[5vh] flex min-h-[650px] w-full overflow-hidden rounded-2xl border border-white/10 bg-[#080809] shadow-[0_25px_100px_rgba(0,0,0,0.6)] md:w-[90%] lg:h-[82vh] lg:w-[70%]">
        <ForgotPasswordLeft />
