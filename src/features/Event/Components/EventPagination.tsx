...
const EventPagination = ({
  ...
  const startIdx = totalEvents === 0 ? 0 : (currentPage - 1) * pageSize + 1;
  const endIdx = Math.min(currentPage * pageSize, totalEvents);
  ...
  return (
    <div className="flex flex-col items-center justify-between gap-4 py-3 sm:flex-row w-full">
      ...
      <p className="text-xs text-white/40">
        ...
        <span className="font-medium text-white/80">{totalEvents}</span> events
      </p>
