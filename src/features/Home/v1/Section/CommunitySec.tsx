...
const CommunitySec = () => {
  ...
  return (
    <section ref={containerRef} className="relative px-5 py-16 sm:px-8 md:px-12 lg:px-[8%] xl:px-[10%]">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none opacity-60">
          <div
            ...
            style={{
              ...
              filter: "drop-shadow(0 0 10px rgba(0, 229, 255, 0.6)) drop-shadow(0 0 20px rgba(66, 133, 244, 0.4))",
              WebkitMaskImage:
        ...
        <div className="relative z-10 flex flex-col items-center justify-between gap-12 lg:flex-row lg:items-start">
          ...
          <div className="flex w-full max-w-2xl flex-col gap-6">
            ...
            <p className="max-w-xl text-sm leading-relaxed text-white/60 sm:text-base">
              Whether you're a beginner or an expert, there's a place for you in GDG Ranchi. Let's learn, build and grow together.
            </p>
          ...
          <div className="flex w-full flex-col items-start gap-8 lg:w-auto lg:items-end">
            ...
            <div className="flex flex-col items-start gap-4 lg:items-center">
              ...
              <div className="flex items-center gap-4">
                <a href="#" className="flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-white/5 text-white/70 transition-colors hover:bg-white/10 hover:text-white">
